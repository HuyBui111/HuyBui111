...
I'm a dedicated QA professional specializing in both manual and automated testing across various platforms. With a keen eye for detail and a passion for quality, I help teams deliver robust, user-friendly software solutions.

- 🔍 Bug hunter with a methodical approach
- 🚀 Automation enthusiast
- 🛠️ Continuous improvement advocate
...
- 🤖 Master advanced test automation techniques
- 🔄 Implement efficient CI/CD pipelines for testing
- 🧠 Explore AI-driven testing approaches
...
<details>
  <summary>📈 Testing Metrics Dashboard (Click to expand)</summary>
  <br>
  
  I'm currently working on a dashboard to track testing metrics across projects. The goal is to provide:
